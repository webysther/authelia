...
_**Note:** This value is completely ignored if the [authorization_signed_response_key_id](#authorization_signed_response_key_id)
is defined._
...
The algorithm chosen must have a key configured in the [issuer_private_keys](provider.md#issuer_private_keys) section to
be considered valid.
...
calculated in the [issuer_private_keys](provider.md#issuer_private_keys).
