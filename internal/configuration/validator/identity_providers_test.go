	...
	testCasses := []struct {
		...
		},
		{
			...
			[]string{
				...
				"identity_providers: oidc: clients: client 'abc': option 'grant_types' must only have the values 'authorization_code' and 'refresh_token' when configured with scope 'authelia.bearer.authz' but the values 'implicit' are present",
		...
		},
		{
			...
			[]string{
				...
				"identity_providers: oidc: clients: client 'abc': option 'response_types' must only have the values 'code' when configured with scope 'authelia.bearer.authz' but the values 'id_token token' are present",
				"identity_providers: oidc: clients: client 'abc': option 'response_modes' must only have the values 'form_post' and 'form_post.jwt' when configured with scope 'authelia.bearer.authz' but the values 'query' are present",
				"identity_providers: oidc: clients: client 'abc': option 'token_endpoint_auth_method' must be configured as ''client_secret_basic', 'client_secret_post', 'client_secret_jwt', or 'private_key_jwt'' when configured with scope 'authelia.bearer.authz' and the 'confidential' client type but it's configured as ''",
			},
		},
		{
			...
			nil,
			[]string{
				"identity_providers: oidc: clients: client 'abc': option 'grant_types' must only have the values 'authorization_code' and 'refresh_token' when configured with scope 'authelia.bearer.authz' but it's not configured",
